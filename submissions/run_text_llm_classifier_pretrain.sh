...
torchrun --nproc_per_node=2 src/cli/finetune_classifier.py --config_filepath configs/llm_classify_without_lora.yaml
# python -m src.pipelines.finetune_llm_classifier \
# --config_filepath configs/llm_classify_without_lora.yaml #pretrained, only classifier
